...
ALTER TABLE threads_outbound_logs ADD COLUMN IF NOT EXISTS approval_expires_at TIMESTAMPTZ;
ALTER TABLE threads_outbound_logs ADD COLUMN IF NOT EXISTS approval_execution_id TEXT;
ALTER TABLE threads_outbound_logs ADD COLUMN IF NOT EXISTS threads_container_id TEXT;
ALTER TABLE threads_outbound_logs ADD COLUMN IF NOT EXISTS publish_attempted_at TIMESTAMPTZ;
ALTER TABLE threads_outbound_logs ADD COLUMN IF NOT EXISTS published_at TIMESTAMPTZ;
